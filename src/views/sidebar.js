...
export const Sidebar = {
  ...
  <div class="list-group sidebar bg-light">
    ...
    <!-- Custom Directives -->
    <div v-if="directives.length > 0" class="list-group-item list-group-item-action rounded-0 bg-success text-white">Custom Directives</div>
    ...
    <!-- External -->
    <div v-if="externals.length > 0" class="list-group-item list-group-item-action rounded-0 bg-dark text-white">External</div>
    ...
    <!-- Draft -->
    <div v-if="drafts.length > 0" class="list-group-item list-group-item-action rounded-0 bg-secondary text-white">Draft</div>
