  ...
  template:
    `
      ...
      <small>selected: {{selected2}}</small>
			<fv-select2 id="demoSelect2" :data-list="pets" data-display="displayName" data-value="value" v-model="selected2" allow-new="true" @onAdd="getNewItem" placeholder="Select color"/>
      <br /> <br />
