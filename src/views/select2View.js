export const Select2View = {
  ...
  template:
    `
      ...
      <h6>Basic usage</h6>
      <h6>
        <pre><code>&lt;fv-select2 id="demoSelect" :data-list="[{value: 'red', displayName: 'Red'}, {value: 'blue', displayName: 'Blue'}]" data-display="displayName" data-value="value" v-model="selected" /&gt;</code></pre>
      </h6>
